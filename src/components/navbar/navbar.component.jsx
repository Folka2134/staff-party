            ...
            <div className="nav-bar bg-set2-primary h-14 w-80 border-2 border-set2-fourth rounded-lg">
                <ul className="nav-list h-full list-none flex justify-evenly items-center">
                    <IconContext.Provider value={{ size: "40"}}>
                        <Link to="cover-container" smooth={true}><li className="btn"><FiMonitor /></li></Link>
                        ...
                        <Link to="disc-container" smooth={true}><li className="btn"><FaCompactDisc /></li></Link>
                        <Link to="vibe-container" smooth={true}><li className="btn"><MdDashboard /></li></Link>
